...
const ClassListPage = async ({
  ...
  const renderRow = (item: Class) => (
    ...
    >
      <td className="min-w-[100px] p-2 text-left">{item.position}</td>
      <td className="min-w-[100px] p-2 text-left">{item.bonus}</td>
      <td className="min-w-[150px] p-2 text-left">{item.accounts}</td>
      <td className="min-w-[200px] p-2 text-left">{item.name}</td>
