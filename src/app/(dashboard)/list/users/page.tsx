...
const StudentListPage = async ({
  ...
  const columns = [
    { header: "Info", accessor: "info", className: "min-w-[250px]" },
    { header: "User ID", accessor: "userId", className: "min-w-[150px]" },
    ...
    { header: "Country", accessor: "address", className: "min-w-[150px]" },
    ...(role === "admin"
  ...
  return (
    <div className="bg-gray-900 min-h-screen w-full flex justify-center">
      <div className="bg-gray-900 p-4 rounded-md flex-1 m-4 mt-0 max-w-7xl w-full">
        ...
        {/* LIST */}
        <div className="overflow-x-auto mt-4 scrollbar-dark bg-gray-900 rounded-md">
