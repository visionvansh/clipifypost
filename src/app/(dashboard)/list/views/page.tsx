...
const renderRow = (item: AssignmentList) => (
  ...
  >
    <td className="flex items-center gap-4 p-4">{item.nameOfPerson}</td>
    <td>{item.socialAccountName}</td>
    <td>{item.views}</td>
  ...
  return (
    <div className="bg-white p-4 rounded-md flex-1 m-4 mt-0">
      ...
      <div className="flex items-center justify-between">
        <h1 className="hidden md:block text-lg font-semibold">Views You Have Made Till Now</h1>
